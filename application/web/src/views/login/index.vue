  ...
  <div class="login-container">
    <el-form ref="loginForm" class="login-form" auto-complete="on" label-position="left">
      ...
      <div class="title-container">
        <h3 class="title">CHAIN PROPERTY</h3>
      </div>
      <el-select v-model="value" placeholder="Select your role" class="login-select" @change="selectGet">
        <el-option
      ...
      <div class="tips">
        <span style="margin-right:20px;">tips: Choose different user roles to trade</span>
      </div>
  ...
  methods: {
    handleLogin() {
      if (this.value) {
        ...
        this.$message('Please Choose your role')
      }
    },
    selectGet(accountId) {
